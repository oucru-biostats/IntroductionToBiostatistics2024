...
<p class="ws-only" style="position: fixed; bottom: 5vh; right: 2vw; padding-right: 2vh; max-width: calc(90vw - 100px); min-width: 100px; pointer-events:none">Trinh Dong and the Biostatistic Group, 2024</p>
